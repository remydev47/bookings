                    ...
                    <div className="w-[200px] flex justify-between m-2.5">
                      ...
                      <div className="flex items-center gap-[10px]">
                        <button
                          ...
                          className="w-[30px] h-[30px] border border-blue-500 cursor-pointer text-[#0071c2] rounded-md"
                          onClick={() => handleOption("adult", "d")}
                        >
                          -
                        </button>
                        <span className="w-[30px] h-[30px] border border-blue-500 cursor-pointer text-[#0071c2] rounded-md">
                          {options.adult}
                        </span>
                        <button
                          className="w-[30px] h-[30px] border border-blue-500 cursor-pointer text-[#0071c2] rounded-md"
